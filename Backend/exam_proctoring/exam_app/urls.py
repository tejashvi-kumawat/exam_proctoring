...
urlpatterns = [
    ...
    path('admin/exams/<int:exam_id>/delete-all-questions/', admin_views.delete_all_exam_questions, name='admin-delete-all-exam-questions'),
    path('admin/attempts/<int:attempt_id>/delete-solutions/', admin_views.delete_attempt_solutions, name='admin-delete-attempt-solutions'),
